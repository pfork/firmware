...
main.gcc.thumb.bin : memmap vectors-systick.o main.gcc.thumb.o $(mainobjs) memset.gcc.thumb.o memcpy.o
	$(ARMGNU)-gcc -nostartfiles -ffreestanding -o main.gcc.thumb.elf -T memmap vectors-systick.o main.gcc.thumb.o $(mainobjs) ./libsodium.a memcpy.o memset.gcc.thumb.o
